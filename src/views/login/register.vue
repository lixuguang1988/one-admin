<template>
  <div class="login">
    ...
    >
      ...
      <IxFormItem control="agree" :controlCol="noLabelControlCol" messageTooltip>
...
const formGroup = useFormGroup({
  ...
  confirmPassword: [
    '',
    {
      ...
      disabled: (control, initializing) =>
        initializing ? true : control.root.get('password')!.invalid.value,
    },
  ],
  nickname: ['', required],
  ...
  captcha: [
    '',
    {
      validators: [required],
      disabled: (control, initializing) =>
        initializing ? true : !control.root.get('agree')!.valueRef.value,
    },
  ],
  agree: [false],
})
